...
//        String queueName2 = "queue_chat_all_" + userId;
//        rabbitAdmin.deleteQueue(queueName2);
//        String queueName3 = "queue_chat_user_" + userId;
//        rabbitAdmin.deleteQueue(queueName3);
//        System.out.println("已删除队列：" + queueName1+queueName2+queueName3);
//    }
//}
//
////私信队列
